...
-- РўР°Р±Р»РёС†Р° EMPLOYEE - СЃРѕС‚СЂСѓРґРЅРёРєРё С„РёСЂРјС‹ --
CREATE TABLE EMPLOYEE (
  employee_id SMALLINT NOT NULL PRIMARY KEY,    -- РљРѕРґ СЃРѕС‚СЂСѓРґРЅРёРєР°
  last_name VARCHAR(15),    -- Р¤Р°РјРёР»РёСЏ
  first_name VARCHAR(15),   -- РРјСЏ
  middle_initial VARCHAR(1),    -- РЎСЂРµРґРЅРёР№ РёРЅРёС†РёР°Р»
  manager_id SMALLINT,  -- РљРѕРґ РЅР°С‡Р°Р»СЊРЅРёРєР°
  job_id SMALLINT,  -- РљРѕРґ РґРѕР»Р¶РЅРѕСЃС‚Рё
  hire_date TIMESTAMP,  -- Р”Р°С‚Р° РїРѕСЃС‚СѓРїР»РµРЅРёСЏ РІ С„РёСЂРјСѓ
  salary NUMERIC(7,2),  -- Р—Р°СЂРїР»Р°С‚Р°
  commission NUMERIC(7,2),  -- РљРѕРјРёСЃСЃРёРѕРЅРЅС‹Рµ
  department_id SMALLINT  );    -- РљРѕРґ РѕС‚РґРµР»Р°

-- РўР°Р±Р»РёС†Р° DEPARTMENT - РѕС‚РґРµР»С‹ С„РёСЂРјС‹ --
CREATE TABLE DEPARTMENT (
  department_id SMALLINT NOT NULL PRIMARY KEY,  -- РљРѕРґ РѕС‚РґРµР»Р°
  name VARCHAR(14), -- РќР°Р·РІР°РЅРёРµ РѕС‚РґРµР»Р°
  location_id SMALLINT );   -- РљРѕРґ РјРµСЃС‚Р° СЂР°Р·РјРµС‰РµРЅРёСЏ

-- РўР°Р±Р»РёС†Р° LOCATION - РјРµСЃС‚Р° СЂР°Р·РјРµС‰РµРЅРёСЏ РѕС‚РґРµР»РѕРІ --
CREATE TABLE LOCATION (
  location_id SMALLINT NOT NULL PRIMARY KEY,    -- РљРѕРґ РјРµСЃС‚Р° СЂР°Р·РјРµС‰РµРЅРёСЏ
  regional_group VARCHAR(20) ); -- Р“РѕСЂРѕРґ

-- РўР°Р±Р»РёС†Р° JOB - РґРѕР»Р¶РЅРѕСЃС‚Рё РІ С„РёСЂРјРµ --
CREATE TABLE JOB  (
  job_id SMALLINT NOT NULL PRIMARY KEY, -- РљРѕРґ РґРѕР»Р¶РЅРѕСЃС‚Рё
  "function" VARCHAR(30) ); -- РќР°Р·РІР°РЅРёРµ РґРѕР»Р¶РЅРѕСЃС‚Рё

-- РўР°Р±Р»РёС†Р° CUSTOMER - С„РёСЂРјС‹-РїРѕРєСѓРїР°С‚РµР»Рё --
CREATE TABLE CUSTOMER (
  customer_id INTEGER NOT NULL PRIMARY KEY, -- РљРѕРґ РїРѕРєСѓРїР°С‚РµР»СЏ
  name VARCHAR(45), -- РќР°Р·РІР°РЅРёРµ РїРѕРєСѓРїР°С‚РµР»СЏ
  address VARCHAR(40),  -- РђРґСЂРµСЃ
  city VARCHAR(30), -- Р“РѕСЂРѕРґ
  state VARCHAR(2), -- РЁС‚Р°С‚
  zip_code VARCHAR(9),  -- РџРѕС‡С‚РѕРІС‹Р№ РєРѕРґ
  area_code SMALLINT,   -- РљРѕРґ СЂРµРіРёРѕРЅР°
  phone_number INTEGER, -- РўРµР»РµС„РѕРЅ
  salesperson_id SMALLINT,  -- РљРѕРґ СЃРѕС‚СЂСѓРґРЅРёРєР°-РїСЂРѕРґР°РІС†Р°, РѕР±СЃР»СѓР¶РёРІР°СЋ-С‰РµРіРѕ РґР°РЅРЅРѕРіРѕ РїРѕРєСѓРїР°С‚РµР»СЏ
  credit_limit NUMERIC(9,2),    -- РљСЂРµРґРёС‚ РґР»СЏ РїРѕРєСѓРїР°С‚РµР»СЏ
  comments VARCHAR(500) );  -- РџСЂРёРјРµС‡Р°РЅРёСЏ

-- РўР°Р±Р»РёС†Р° SALES_ORDER - РґРѕРіРѕРІРѕСЂС‹ Рѕ РїСЂРѕРґР°Р¶Рµ --
CREATE TABLE SALES_ORDER (
  order_id SMALLINT NOT NULL PRIMARY KEY,   -- РљРѕРґ РґРѕРіРѕРІРѕСЂР°
  order_date DATE,  -- Р”Р°С‚Р° РґРѕРіРѕРІРѕСЂР°
  customer_id INTEGER,  -- РљРѕРґ РїРѕРєСѓРїР°С‚РµР»СЏ
  ship_date DATE,   -- Р”Р°С‚Р° РїРѕСЃС‚Р°РІРєРё
  total NUMERIC(8,2) ); -- РћР±С‰Р°СЏ СЃСѓРјРјР° РґРѕРіРѕРІРѕСЂР°

-- РўР°Р±Р»РёС†Р° ITEM - Р°РєС‚С‹ РїСЂРѕРґР°Р¶ --
CREATE TABLE ITEM (
  order_id SMALLINT NOT NULL,   -- РљРѕРґ РґРѕРіРѕРІРѕСЂР°, РІ СЃРѕСЃС‚Р°РІ РєРѕС‚РѕСЂРѕРіРѕ РІС…РѕРґРёС‚ Р°РєС‚
  item_id SMALLINT NOT NULL,    -- РљРѕРґ Р°РєС‚Р°
  product_id INTEGER,   -- РљРѕРґ РїСЂРѕРґСѓРєС‚Р°
  actual_price NUMERIC(8,2),    -- Р¦РµРЅР° РїСЂРѕРґР°Р¶Рё
  quantity INTEGER, -- РљРѕР»РёС‡РµСЃС‚РІРѕ
  total NUMERIC(8,2),   -- РћР±С‰Р°СЏ СЃСѓРјРјР°
PRIMARY KEY (order_id,item_id)
);

-- РўР°Р±Р»РёС†Р° PRODUCT - С‚РѕРІР°СЂС‹ --
CREATE TABLE PRODUCT (
  product_id INTEGER NOT NULL PRIMARY KEY,  -- РљРѕРґ РїСЂРѕРґСѓРєС‚Р°
  description VARCHAR(30) );    -- РќР°Р·РІР°РЅРёРµ РїСЂРѕРґСѓРєС‚Р°

-- РўР°Р±Р»РёС†Р° PRICE - С†РµРЅС‹ --
CREATE TABLE PRICE (
  product_id INTEGER NOT NULL,  -- РљРѕРґ РїСЂРѕРґСѓРєС‚Р°
  list_price NUMERIC(8,2),  -- РћР±СЉСЏРІР»РµРЅРЅР°СЏ С†РµРЅР°
  min_price NUMERIC(8,2),   -- РњРёРЅРёРјР°Р»СЊРЅРѕ РІРѕР·РјРѕР¶РЅР°СЏ С†РµРЅР°
  start_date DATE NOT NULL, -- Р”Р°С‚Р° СѓСЃС‚Р°РЅРѕРІР»РµРЅРёСЏ С†РµРЅС‹
  end_date DATE,    -- Р”Р°С‚Р° РѕС‚РјРµРЅС‹ С†РµРЅС‹
